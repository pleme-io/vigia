  ...
  internal = rec {
    ...
    crates = {
      ...
      "cracha-core" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../cracha/crates/cracha-core; };
        libName = "cracha_core";
        authors = [
      ...
      "cracha-proto" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../cracha/crates/cracha-proto; };
      ...
      "kube" = rec {
        ...
        resolvedDefaultFeatures = [ "derive" "kube-derive" ];
      };
      "kube-core" = rec {
        crateName = "kube-core";
        version = "0.99.0";
        ...
        resolvedDefaultFeatures = [ "schema" "schemars" ];
      };
      "kube-derive" = rec {
      ...
      "regex-automata" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "dfa-build" "dfa-search" "meta" "nfa-pikevm" "nfa-thompson" "std" "syntax" "unicode-bool" ];
      };
      "regex-syntax" = rec {
      ...
      "vigia" = rec {
        ...
        features = {
          "cracha-grpc" = [ "dep:cracha-proto" ];
        };
        resolvedDefaultFeatures = [ "cracha-grpc" "default" ];
      };
      "want" = rec {
        crateName = "want";
        version = "0.3.1";
